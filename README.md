...
The module also comes ready-made: `sudo apt install libsmspp-mcflemon-dev` from
the [PPA of the project](https://launchpad.net/~smspp-project/+archive/ubuntu/smspp), and
`vcpkg install "smspp[core,mcflemon]"` from the [SMS++ vcpkg
